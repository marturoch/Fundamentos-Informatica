...
import re 
text = open(r'C:\Users\martu\Documents\martu\UCEMA\2 - PRIMER CUATRI\INFORMATICA\Python_intro\manipulacion_archivos.txt', 'r') #aca estamos haciendo que abra el archivo para que lo pueda leer, pero no lo lee todavia
