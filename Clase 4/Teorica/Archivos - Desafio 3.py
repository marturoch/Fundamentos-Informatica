...
with open(r'C:\Users\martu\Documents\martu\UCEMA\2 - PRIMER CUATRI\INFORMATICA\creacion de archivos y carpetas para los practicos\Bio.txt', 'w') as file:
    file.write("Me llamo Martina. \nTengo 19. \nEstoy en mi segundo año de facultad estudiando Negocios Digitales en UCEMA.") #le doy formato con "\n"
#para ver si funciono: 
texto = open(r'C:\Users\martu\Documents\martu\UCEMA\2 - PRIMER CUATRI\INFORMATICA\creacion de archivos y carpetas para los practicos\Bio.txt','r')
text = texto.read()
print(text)
texto.close()
