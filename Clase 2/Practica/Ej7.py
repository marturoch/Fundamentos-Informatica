...
# Realizar un programa que devuelva el dinero que recibirá por comisión luego de 4 ventas y 
# el total de dinero que ganará ese mes, teniendo en cuenta estas ventas y su sueldo base
